...
public class DetailsActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mProductNameViewText = findViewById(R.id.product_name_viewtext);
        mProductPriceViewText = findViewById(R.id.product_price_viewtext);
        mProductQuantityViewText = findViewById(R.id.product_quantity_viewtext);
        mProductSupplieNameSpinner = findViewById(R.id.product_supplier_name_viewtext);
        mProductSupplierPhoneNumberViewText = findViewById(R.id.product_supplier_phone_viewtext);
        ...
        Log.d("system", "onCreate ViewActivity");
    ...
    public Loader<Cursor> onCreateLoader(int i, Bundle bundle) {
        String[] projection = {
                ...
                InventoryContract.InvEntry.COLUMN_PRODUCT_NAME,
                InventoryContract.InvEntry.COLUMN_PRODUCT_PRICE,
                InventoryContract.InvEntry.COLUMN_PRODUCT_QUANTITY,
                InventoryContract.InvEntry.COLUMN_PRODUCT_SUPPLIER_NAME,
                InventoryContract.InvEntry.COLUMN_PRODUCT_SUPPLIER_PHONE
        };
        ...
        if (cursor.moveToFirst()) {
            ...
            switch (currentSupplierName) {
                ...
                case InvEntry.SUPPLIER_SOUQ:
                    mProductSupplieNameSpinner.setText(getText(R.string.supplier_souq));
                    break;
    ...
    public void decreaseCount(int productID, int productQuantity) {
        ...
        if (productQuantity >= 0) {
            ...
            Log.d("system", " - productID " + productID + " - quantity " + productQuantity + " , decreaseCount has been called.");
        } else {
